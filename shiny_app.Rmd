    ...
    tabItem(tabName = "origin_table",
            ...
            fluidRow(
              ...
              box(solidHeader = TRUE,
                  ...
                  sliderInput(inputId = "row_num", label = "Choose observation number:", min = 1, max = 1000, value = 20)
                  ),
              #table output
              box(
                  width = 12,
...
server <- function(input, output) {
  ...
  observeEvent(input$click_update, {
    ...
    output$update_result <- renderText({
        paste0(row_effected,"row(s) has been effected.")
      })
  ...
  observeEvent(input$click_insert, {
    ...
    output$insert_result <- renderText({
        paste0(row_effected," has been effected.")
      })
